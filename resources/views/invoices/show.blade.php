<x-app-layout>
    <x-slot name="header">
        <x-page-header :title="'Invoice ' . $invoice->invoice_number" :back="route('invoices.index')">
            <x-slot name="action">
    ...
    <div class="max-w-3xl mx-auto bg-white shadow-sm border border-gray-100 rounded-2xl p-8">
